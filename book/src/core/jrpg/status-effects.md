...
>
> If you come from Unity (coroutines) or JavaScript (timeouts/intervals/animation-frame-requests), or you just used threads before to achieve background work, you might have been using similar pattern already!
...
Quite simpler to understand than explicit state machines signalled with events, don't you think? Maintanance and expanding of such logic is also quite easy to perform, as there isn't much of moving parts scattered around that need careful focus to connect.
